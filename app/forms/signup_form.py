...
class SignUpForm(FlaskForm):
    username = StringField('Username', validators=[DataRequired('Username is required!'), Length(max=40, message='Username can only have 40 characters max!'), username_exists])
